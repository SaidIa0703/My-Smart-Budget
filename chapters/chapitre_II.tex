  ...
  \item Section enveloppes (bas de page) :
    \begin{itemize}
      \item Liste des enveloppes avec barres de progression :
        \begin{itemize}
          \item "Alimentation" : 385€/400€ (96\,\%, barre orange, attention)
          \item "Loisirs" : 120€/300€ (40\,\%, barre verte, valider)
          \item "Transport" : 210€/200€ (105\,\%, barre rouge, refusé, texte "Dépassement de 10€")
        \end{itemize}
    \end{itemize}
\end{enumerate}
