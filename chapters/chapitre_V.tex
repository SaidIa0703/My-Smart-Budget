...
\begin{figure}[H]
    \centering
    % Placeholder pour ton schéma d'architecture
    \includegraphics[width=0.9\textwidth]{assets/images/architecture_3_tiers.png}
...
La gestion des transactions nécessite une validation rigoureuse côté client pour garantir l'intégrité des données avant l'envoi au serveur.
...
C'est ici que réside l'intelligence de l'application (calculs, règles de gestion).
