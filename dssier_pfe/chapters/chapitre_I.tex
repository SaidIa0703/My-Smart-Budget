...
\begin{center}
\small$\rightarrow$~\textit{Diagramme de contexte — voir Annexe~\ref{ann:figures}, figure~\ref{fig:diagramme_contexte}}
\end{center}
...
\begin{itemize}
    \item \textbf{Utilisateur final :} Consulte dashboard, saisit transactions, configure budgets $\rightarrow$ \textit{Frontend React}
...
\begin{center}
\small$\rightarrow$~\textit{Diagramme de classes UML — voir Annexe~\ref{ann:figures}, figure~\ref{fig:diagramme_classes}}
\end{center}
