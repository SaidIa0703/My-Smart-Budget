...
\begin{itemize}
    ...
    \item \textbf{Temporel :} Déployer une \textbf{version 1.0} de l'application au plus tard en \textbf{octobre 2024}, incluant l'ensemble des fonctionnalités de base (gestion des transactions, budgets, catégories, tableaux de bord), puis planifier une \textbf{version 2.0 en avril 2026} intégrant au moins \textbf{deux nouvelles fonctionnalités} issues des retours utilisateurs.
\end{itemize}
...
\textbf{Version 1.1 (Janvier 2026) :}
\begin{itemize}
...
\textbf{Version 3.0 (Septembre 2026) :}
\begin{itemize}
...
\textbf{Objectif long terme :} Atteindre \textbf{50 utilisateurs beta actifs} d'ici fin 2026 avec un NPS $>$ 30.
\end{tcolorbox}
