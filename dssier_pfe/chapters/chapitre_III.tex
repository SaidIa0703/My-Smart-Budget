...
\hline
\textbf{POC} & 05/10/2024 & Backend Node.js + Connexion DB. Première route API. \\
\hline
\textbf{MVP (v1.0)} & 15/10/2024 & Auth JWT, CRUD complet, Dashboard v1. \\
\hline
\textbf{Bêta (v1.1)} & 30/10/2024 & Alertes budgétaires, CI/CD complet. \\
\hline
\textbf{Finale (v2.0)} & 15/11/2024 & Export PDF, Optimisations Perf, Documentation finale. \\
\hline
\end{tabular}
\end{center}
