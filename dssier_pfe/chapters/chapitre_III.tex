...
\hline
\textbf{POC} & 02/04/2026 & Backend Node.js + Connexion DB. Première route API. \\
\hline
\textbf{MVP (v1.0)} & 16/04/2026 & Auth JWT, CRUD complet, Dashboard v1. \\
\hline
\textbf{Bêta (v1.1)} & 30/04/2026 & Import CSV, Alertes, CI/CD complet. \\
\hline
\textbf{Finale (v2.0)} & 15/05/2026 & Export PDF, Optimisations Perf, Documentation finale. \\
\hline
\end{tabular}
\end{center}
