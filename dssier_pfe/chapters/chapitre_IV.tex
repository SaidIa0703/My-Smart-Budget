...
Le modèle de données a été conçu selon la méthode Merise (MCD/MLD/MPD) puis implémenté physiquement sous PostgreSQL 16.
...
Le MPD précise les types SQL, contraintes (\texttt{NOT NULL}, \texttt{UNIQUE}, \texttt{ON DELETE CASCADE}) et index de chaque table tels qu'implémentés sous PostgreSQL 16.
