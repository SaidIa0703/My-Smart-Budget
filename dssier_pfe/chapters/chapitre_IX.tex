...
\begin{itemize}
    \item \textbf{React Conf 2025 :} React 19 preview, Server Components
...
// 3. Rate limiting intelligent (Décembre 2025)
...
\begin{tcolorbox}[colback=green!5!white,colframe=green!60!black,title=\textbf{ROI de la veille technologique (2025)}]
\begin{center}
\begin{tabular}{|l|c|c|c|}
\hline
...
L'essentiel est que j'essaie de garder une stack à jour, sans mettre en danger la stabilité du projet. Chaque mise à jour est évaluée, testée en staging, et documentée avant d'aller en production.
\end{tcolorbox}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!60!black,title=\textbf{Programme de knowledge sharing 2025}]
...
\begin{enumerate}
    ...
    \item \textbf{Septembre :} "State Management 2025" (47 participants)
