...
describe('BudgetCalculatorService', () => {
  ...
  describe('calculateRemainingBudget', () => {
    it('should calculate remaining budget correctly', async () => {
      ...
      mockBudgetModel.queryOne.mockResolvedValue(budget);
    ...
    it('should handle empty transactions', async () => {
      // Arrange
      mockBudgetModel.queryOne.mockResolvedValue({
        id: 1,
        monthly_limit: 500
      });
  ...
  describe('calculateResteAVivre', () => {
    it('should calculate "reste à vivre" correctly', async () => {
      ...
      // Mock requête SQL agrégat
      mockTransactionModel.query.mockResolvedValue([
        { type: 'income', total: 2500 },
        { type: 'expense', total: 1800 }
      ]);
...
✓ monthly_spike: 14m0s
     ...
     checks.........................: 97.80%  ✓ 3420    ✗ 76
     data_received..................: 214 MB  256 kB/s
     data_sent.....................: 58 MB   69 kB/s
     http_req_blocked...............: avg=2.1ms    p(95)=8.4ms
     http_req_connecting............: avg=0.8ms    p(95)=3.2ms
   ✓ http_req_duration..............: avg=312.5ms  p(95)=742.3ms  p(99)=1480ms
       { expected_response:true }...: avg=308.2ms  p(95)=731.4ms  p(99)=1462ms
   ✓ http_req_failed................: 2.20%   ✓ 109      ✗ 4841
     http_req_receiving.............: avg=2.3ms    p(95)=8.7ms
     http_req_sending...............: avg=0.4ms    p(95)=1.2ms
     http_reqs.....................: 4950    5.89/s
     iteration_duration.............: avg=18.4s    p(95)=27.3s
     iterations....................: 825     0.98/s
   ✓ login_errors...................: 1.21%   ✓ 10       ✗ 815
   ✓ import_duration................: avg=3212ms   p(95)=4621ms   p(99)=5840ms
   ✓ dashboard_load_time............: avg=1183ms   p(95)=1876ms   p(99)=2310ms
     vus...........................: 1       min=1      max=47
...
POST /import/csv & 1,842 & 3,421 & 5,123 & 14 \\
...
Tests exécutés par build & 457 & ↑ +63 \\
Déploiements réussis & 27/28 (96.4\%) & → stable \\
...
\begin{itemize}
    ...
    \item \textbf{PostgreSQL Performance :} \url{https://www.postgresql.org/docs/current/performance-tips.html}
\end{itemize}
