...
\begin{center}
\begin{center}\small\textit{\textrightarrow{} Badge SonarQube — voir Annexe~\ref{ann:figures}, figure~\ref{fig:sonarqube-badge}}\end{center}
\end{center}
...
\begin{enumerate}
    \item \textbf{Augmenter la couverture à 90\%} — Mon objectif personnel est de concentrer l'effort sur les composants React (actuellement 76,8\%) et d'ajouter des tests de mutation (Stryker.js).
    ...
    \item \textbf{Améliorer la performance P99} — Objectif P99 < 1500ms (actuellement 1842ms) via l'optimisation des requêtes MongoDB et un cache Redis sur les endpoints lourds.
