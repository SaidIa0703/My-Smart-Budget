...
Performance P95 < 800ms & \mycheckmark Atteint & 342ms & Dépassé l'objectif \\
...
Tests E2E manquants & Haute & 1 semaine & Qualité & \mycheckmark{} Résolu (28 tests Cypress) \\
Documentation API & Basse & 3 jours & Développement & \mycheckmark{} Résolu (OpenAPI/Swagger \texttt{/api/docs}) \\
...
\begin{itemize}
    ...
    \item \textbf{DevOps :} Pipeline CI/CD avec déploiement SSH via docker-compose sur AWS EC2
\end{itemize}
