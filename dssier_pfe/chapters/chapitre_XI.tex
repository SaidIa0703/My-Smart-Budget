...
\begin{verbatim}
Q1 2026: Fonctionnalités avancées
+-- Import CSV bancaire automatique
+-- Notifications de dépassement de budget
+-- Optimisation performances (P95 < 500ms)
+-- Tests E2E étendus
...
services:
  app:
    ...
    environment:
      ...
      - MONGO_URI=mongodb://mongodb:27017/smart_budget
    depends_on:
      - postgres
      - mongodb
  ...
  mongodb:
    image: mongo:7
    environment:
      - MONGO_INITDB_DATABASE=smart_budget
    volumes:
